...
<div class="bg-white rounded-lg shadow-xl p-6">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">
        <i class="fas fa-user-edit text-indigo-600"></i> Edit Guest: {{ $guest->full_name }}
    </h1>
    ...
    <form action="{{ route('guests.update', $guest) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $guest->first_name) }}" 
            ...
            <div>
                ...
                <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $guest->last_name) }}" 
            ...
            <div>
                ...
                <input type="text" name="id_number" id="id_number" value="{{ old('id_number', $guest->id_number) }}" 
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" id="address" rows="3" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('address') border-red-500 @enderror">{{ old('address', $guest->address) }}</textarea>
                @error('address')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
