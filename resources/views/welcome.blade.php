...
@section('title', 'Welcome - Booking Management')
...
<div class="text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        <!-- Guests Card -->
        <a href="{{ route('guests.index') }}" class="bg-white rounded-lg shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-1">
        ...
        <!-- Apartments Card -->
        <a href="{{ route('apartment-houses.index') }}" class="bg-white rounded-lg shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-1">
        ...
        <!-- Bookings Card -->
        <a href="{{ route('bookings.index') }}" class="bg-white rounded-lg shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-1">
    ...
    <div class="mt-16">
        ...
        <div class="flex justify-center space-x-4">
            <a href="{{ route('guests.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300">
                <i class="fas fa-user-plus mr-2"></i> Add Guest
            </a>
            <a href="{{ route('apartment-houses.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300">
                <i class="fas fa-plus mr-2"></i> Add Apartment
            </a>
            <a href="{{ route('bookings.create') }}" class="bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300">
