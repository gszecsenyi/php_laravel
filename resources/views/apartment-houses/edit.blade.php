...
<div class="bg-white rounded-lg shadow-xl p-6">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">
        <i class="fas fa-edit text-purple-600"></i> Edit Apartment: {{ $apartmentHouse->name }}
    </h1>

    <form action="{{ route('apartment-houses.update', $apartmentHouse) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $apartmentHouse->name) }}" 
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" id="address" rows="2" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 @error('address') border-red-500 @enderror" required>{{ old('address', $apartmentHouse->address) }}</textarea>
                @error('address')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="3" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 @error('description') border-red-500 @enderror">{{ old('description', $apartmentHouse->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="number_of_rooms" id="number_of_rooms" value="{{ old('number_of_rooms', $apartmentHouse->number_of_rooms) }}" min="1"
            ...
            <div>
                ...
                <input type="number" name="max_guests" id="max_guests" value="{{ old('max_guests', $apartmentHouse->max_guests) }}" min="1"
            ...
            <div>
                ...
                <input type="number" name="price_per_night" id="price_per_night" value="{{ old('price_per_night', $apartmentHouse->price_per_night) }}" step="0.01" min="0"
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_available" id="is_available" value="1" {{ old('is_available', $apartmentHouse->is_available) ? 'checked' : '' }}
